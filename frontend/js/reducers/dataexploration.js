...
const {SET_FILTER, SELECT_AREA, SHOW_DETAILS, SHOW_FILTER, UPDATE_DATA_URL, SET_SORT_TYPE, SHOW_RELATED_DATA, UPDATE_BBOX_FILTER} = require('../actions/dataexploration');
