...
var ImageButton = require('../../../MapStore2/web/client/components/buttons/ImageButton');
...
class ToggleButton extends React.Component {
    ...
    renderNormalButton = () => {
        return (
            <Button id={this.props.id} {...this.props.btnConfig} active={this.props.pressed} onClick={this.onClick} bsStyle={this.props.pressed ? this.props.pressedStyle : this.props.defaultStyle} style={this.props.style}>
