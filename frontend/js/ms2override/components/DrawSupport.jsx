...
const {isSimpleGeomType, getSimpleGeomType} = require('../../../MapStore2/web/client/utils/MapUtils');
...
*/
    ...
    addDrawInteraction = (drawMethod, startingPoint, maxPoints) => {
        ...
        if (drawMethod === 'DRAGBOX') {
            ...
            this.drawInteraction.on('boxend', function(evt) {
                this.sketchFeature = new ol.Feature({
                    geometry: ol.geom.Polygon.fromExtent([...startCoord, ...evt.coordinate])
                });

                const vectorSource = new ol.source.Vector();
                vectorSource.addFeature(this.sketchFeature);
