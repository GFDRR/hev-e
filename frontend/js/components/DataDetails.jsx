...
module.exports = props => {
    ...
    const filterName = props.currentDetails && props.currentDetails.properties && props.currentDetails.properties.category
        || props.currentDetails && props.currentDetails.vulnerability_type;
    const name = props.currentDetails && props.currentDetails.properties && props.currentDetails.properties.name
        || props.currentDetails && props.currentDetails.name;
    ...
    return props.currentDetails ? (
        ...
        { ({width}) =>
            <div style={{
                ...
                <ResizableModal
                    show
                    title={<span><i className={'fa fa-' + icon}/>&nbsp;<strong>{name}</strong></span>}
