            ...
            <div className={'et-related-data' + className}>
                ...
                {this.props.showData ? <Row className="ms-header" style={{paddingBottom: 15}}>
                        ...
                        <Col xs={8} className="text-center">
                            {this.props.currentDetails && (this.props.currentDetails.title || this.props.currentDetails.name) && <h3>Data related to: <a href="#" onClick={() => {
                                this.props.onShowData(false);
                            }}><strong>{this.props.currentDetails.title || this.props.currentDetails.name}</strong></a></h3>}
                        </Col>
                        <Col xs={2}/>
